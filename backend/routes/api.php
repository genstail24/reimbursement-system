...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::prefix('categories')->group(function () {
        Route::middleware('permission:category.view|reimbursement.create|reimbursement.view|user.view')->get('/', [CategoryController::class, 'index']);
        Route::middleware('permission:category.view|reimbursement.create|reimbursement.view|user.view')->get('{category}', [CategoryController::class, 'show']);
